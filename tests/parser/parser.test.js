...
const canvasContainsAutoProps = (match) => {
    return (canvas) => {
        const res = [];
        const collectIfDefined = (a, prop) => { if (prop)
            a.push(prop); };
        function containerName(container) {
            ...
            if (container instanceof GraphGroup) {
                return `:${(_a = container.getName()) !== null && _a !== void 0 ? _a : ''}`;
            }
            if (container instanceof GraphInner) {
                return `:${(_b = container.getName()) !== null && _b !== void 0 ? _b : ''}`;
            }
        ...
        canvas.getObjects().forEach(function c(connectable) {
            if (connectable instanceof GraphContainer) {
                ...
                if (connectable instanceof GraphVertex) {
                    collectIfDefined(vertexProps, connectable.getImage());
                }
        ...
        canvas.getEdges().forEach(edge => {
            ...
            collectIfDefined(edgeProps, ((_a = edge.parent) === null || _a === void 0 ? void 0 : _a.getName()) ? edge.parent.getName() : '');
...
const grammarTests = [
    ...
    { g: 'node>(a>(b c)>d)', f: [canvasContainsAutoProps(['node', ':1', ':1,a', ':2', ':2,b', ':2,c', ':2,d', 'node,>,a,1', 'a,>,b,2', 'a,>,c,2', '2,>,d,1'])] },
    { g: '(a,b,c)>node', f: [canvasContainsAutoProps([':1', ':1,a', ':1,b', ':1,c', ':1,node', '1,>,node'])] },
    { g: '(a b c)>node', f: [canvasContainsAutoProps([':1', ':1,a', ':1,b', ':1,c', ':1,node', '1,>,node'])] },
    ...
    { g: 'generator ast', f: [canvasHas('generator', 'abba')] },
    {
        g: `cloud inet-router {
      router web01 web02
  }`,
...
describe('Parser/grammar rule tests', () => {
    ...
    beforeAll(async () => {
        ...
        getParserYY().result = function (result) {
            throw new Error('Setup failure');
        };
        getParserYY().USE_GENERATOR = 'abba';
        getParserYY().parseError = function (str, hash) {
...
exit;exit node is also required
            ...
            if (obj instanceof GraphConditional) {
                ...
                switch (objectName) {
                    case '1':
                        ...
                        expect((_a = obj._conditionalEntryEdge) === null || _a === void 0 ? void 0 : _a.getName()).toBe('entry');
                        break;
                    case '2':
                    ...
                    case '3':
                        ...
                        expect((_b = obj._conditionalExitEdge) === null || _b === void 0 ? void 0 : _b.getName()).toBe('exit');
                        break;
                }
            }
    ...
    it('graphContent/readEvents/state 36', async () => {
        ...
        expect((_a = graphcanvas.lastSeenVertex) === null || _a === void 0 ? void 0 : _a.getName()).toBe('e');
