...
export const mapMethodProperties = <
  ...
  T extends Record<MethodOrNonOptionalProperty, any>>(obj: T, mapProperties: Array<[MethodOrNonOptionalProperty, PropertyObtainedCB]>, results: string[], context?: any): void => {
...
export const mapPropertyProperties = <T, K extends keyof T>(obj: T, mapProperties: Array<[K, PropertyObtainedCB]>, results: string[], context?: any) => {
  for (const [m, cb] of mapProperties) {
    if (typeof (obj[m]) === 'function') {
      continue
    }
...
export const mapMethodsOrProperties = (obj: any, mapProperties: Array<[prop: string, cb: PropertyObtainedCB]>, results?: string[], context?: any) => {
