...
build/state.all: grammar/state.lex grammar/lexmarker.txt grammar/state.grammar model/support.js model/model.js model/graphmeta.js model/graphobject.js model/node.js model/group.js model/graphroot.js model/link.js model/shapes.js model/subgraph.js model/tree.js generators/*.js
	@mkdir -p build
