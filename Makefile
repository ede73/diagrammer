...
build/state.all: grammar/state.lex grammar/lexmarker.txt grammar/state.grammar model/support.js model/model.js model/graphmeta.js model/graphobject.js model/graphvertex.js model/group.js model/graphroot.js model/graphedge.js model/shapes.js model/subgraph.js model/tree.js generators/*.js
	@mkdir -p build
